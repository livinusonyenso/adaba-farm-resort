...
const config = {
  ...
  EMAIL: {
    ...
    ADMIN: 'adabafarmresort@kazfieldisl.com', // Admin email for general notifications
    // Dedicated subscription email - receives all subscription form submissions
    SUBSCRIPTION_ADMIN: process.env.SUBSCRIPTION_EMAIL || 'adabafarmresortsubscription@kazfieldisl.com',
    ...
    FROM_SUBSCRIPTION: `"Àdàbà Farm and Resort" <${process.env.SUBSCRIPTION_EMAIL || 'adabafarmresortsubscription@kazfieldisl.com'}>`,
