        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            >
              <p className="text-base md:text-lg">
                ...
                environment of <strong>Owode Obafe, Ogun State</strong>, Àdàbà Farm and Resort combines cutting-edge
          ...
          >
            <Image
              ...
              alt="Àdàbà Coconut Farm - Lush green coconut plantation in Owode Obafe, Ogun State"
              fill
